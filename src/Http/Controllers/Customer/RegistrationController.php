...
namespace Webkul\GolobaTheme\Http\Controllers\Customer;
...
use Webkul\GolobaTheme\Http\Requests\Customer\RegistrationRequest;
...
class RegistrationController extends Controller
{
    ...
    {
        return view('shop::customers.sign-up')->withErrors([]);
    }
