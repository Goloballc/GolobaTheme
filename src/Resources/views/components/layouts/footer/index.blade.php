...
<footer class="mt-9 bg-grayGolobaLight max-sm:mt-10">
    <div class="flex justify-between gap-x-6 gap-y-8 p-[60px] max-1060:flex-col-reverse max-md:gap-5 max-md:p-8 max-sm:px-4 max-sm:py-5">
        ...
        @if (core()->getConfigData('customer.settings.newsletter.subscription'))
            <div class="grid gap-2.5">
                <p
                    class="max-w-[288px] text-3xl font-bold leading-[45px] text-magentaGoloba max-md:text-2xl max-sm:text-lg"
                    role="heading"
                    aria-level="2"
                >
                ...
                <div>
                    ...
                    >
                        <div class="relative w-full">
                            ...
                            <button
                                type="submit"
                                class="absolute top-1.5 flex w-max items-center rounded-xl bg-greenGoloba px-7 py-2.5 font-medium max-md:top-1 max-md:px-5 max-md:text-xs max-sm:mt-0 max-sm:rounded-lg max-sm:px-4 max-sm:py-2 ltr:right-2 rtl:left-2"
                            >
    ...
    <div class="flex justify-between bg-grayGolobaDark px-[60px] py-3.5 max-md:justify-center max-sm:px-5">
