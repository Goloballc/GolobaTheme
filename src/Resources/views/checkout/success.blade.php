...
>
	...
	{{-- En tu vista, por ejemplo, resources/views/checkout/success.blade.php --}}


    <x-message-card
        iconType="class"
        iconValue="fas fa-check" {{-- Asegúrate de tener Font Awesome y esta clase disponible --}}
        iconBgClass="bg-green-500"
        iconFgClass="text-white"
        title="¡Pago exitoso!"
        subtitle="Número de orden: #12345678"
        description="¡Muchas gracias por tu compra! Tu pago se ha procesado correctamente. Estamos trabajando para despachar tu órden lo antes posible."
        :buttons="[
            ['text' => 'Ver detalles del pedido', 'url' => 'https://google.com', 'type' => 'primary'],
            ['text' => 'Volver al inicio', 'url' => 'https://google.com', 'type' => 'secondary']
        ]"
    />
