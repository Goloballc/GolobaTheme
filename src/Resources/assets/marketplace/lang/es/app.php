...
return [
    'admin' => [
        'system' => [
            'info'  => 'Configuración del Marketplace',
            'title' => 'Marketplace',

            'settings' => [
                'app-version'       => 'Versión de la Aplicaciónv2.2.2',
                'info'              => 'Administrar Configuración del Marketplace',
                ...
                'general' => [
                    ...
                    'custom-product-flag-reason' => 'Razón Personalizada para Denunciar Producto',
                    'description'                => 'Establece la aprobación para el marketplace, las características accesibles para el vendedor y la comisión global del marketplace.',
                    'enable-product-flag'        => 'Habilitar Denuncia de Producto',
                    'featured-product'           => 'Mostrar Producto Destacado',
                    'guest-can-product-flag'     => 'Los Invitados Pueden Denunciar Productos',
                    'line-in-a-street-address'   => 'Líneas en una Dirección de Calle',
                    ...
                    'seller-can-assign-product'  => 'El vendedor puede asignar productos',
                    'seller-can-create-product'  => 'El vendedor puede crear productos',
                    'status'                     => 'Estado',
                    'title'                      => 'General',
                ],
                ...
                'landing-page' => [
                    ...
                    'description'         => 'Personaliza la página de inicio del marketplace, agregando iconos, banners y descripciones para un aspecto fresco.',
        ...
        'acl' => [
            ...
            'products'             => 'Productos',
            'product-flag-reasons' => 'Razones de Denuncia de Producto',
            'reviews'              => 'Reseñas del Vendedor',
            'seller-categories'    => 'Categorías de vendedores',
            'seller-flag-reasons'  => 'Motivos de Denuncia del Vendedor',
            'sellers'              => 'Vendedores',
            'title'                => 'Marketplace',
        ...
        'sellers' => [
            'index' => [
                ...
                'datagrid' => [
                    ...
                    'total-flags'    => 'Total de Denuncias: :count',
        ...
        'product-flag-reasons' => [
            'index' => [
                ...
                'title'      => 'Razones de Denuncia de Producto',

                'create' => [
                    'reason'   => 'Razón',
                    'save-btn' => 'Guardar Razón',
                    'status'   => 'Estado',
                    'success'  => 'Razón de marca de producto creada con éxito.',
                    'title'    => 'Crear Razón',
                ],

                'edit' => [
                    'success' => 'Razón de marca de producto actualizada con éxito.',
                    'title'   => 'Actualizar Razón',
                ],

                'delete-failed'  => '¡Error al eliminar la razón de marca de producto!',
                'delete-success' => 'Razón de marca de producto eliminada con éxito.',
                'update-success' => 'Razón de marca de producto actualizada con éxito.',
        ...
        'seller-flag-reasons' => [
            'index' => [
                ...
                'title'      => 'Motivos de denuncia del vendedor',
    ...
    'shop' => [
        ...
        'products' => [
            ...
            'report-success'           => 'Producto reportado con éxito.',
            'already-product-reported' => 'Producto ya reportado.',
        ],
        ...
        'sellers' => [
            ...
            'account' => [
                ...
                'signup' => [
                    ...
                    'name'             => 'Nombre del responsable de la tienda',
                    'page-title'       => 'Conviértete en vendedor',
                    'password'         => 'Contraseña',
                    'sign-in-button'   => 'Iniciar sesión',
                    'success'          => 'Cuenta creada exitosamente.',
                    'url'              => 'Dirección de tu perfil. Ej: escribe mi-marca para usar goloba.com/mi-marca',
                ],
                ...
                'users' => [
                    'index' => [
                        ...
                        'datagrid' => [
                            ...
                            'email'       => 'Correo Electrónico',
                            'flags'       => 'Denuncias',
                            'flags-value' => 'Total de Denuncias - :count',
                            'id'          => 'ID',
                            'id-value'    => 'ID - :id',
                            'name'        => 'Nombre',
                            'permission'  => 'Permiso',
