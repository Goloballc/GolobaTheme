...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© :current_year, Goloba Marketplace. Todos los derechos reservados.',
        ...
        'reset-password' => [
            ...
            'footer'           => '© Goloba :current_year. Todos los derechos reservados.',
            'password'         => 'Contraseña',
        ...
        'signup-form' => [
            ...
            'last-name'                   => 'Apellidos',
            'page-title'                  => 'Conviertete en comprador',
            'password'                    => 'Contraseña',
            'phone'                       => 'Número de Teléfono',
            'phone-required'              => 'El campo número de teléfono es obligatorio.',
            'phone-max'                   => 'El número de teléfono no puede ser mayor a 20 caracteres.',
            'phone-unique'                => 'El número de teléfono ya ha sido tomado.',
            'instagram-url'               => 'URL de Instagram',
            'instagram-url-invalid'       => 'El formato de la URL de Instagram no es válido.',
            'instagram-url-max'           => 'La URL de Instagram no puede ser mayor a 255 caracteres.',
            'accept-policy'               => 'Acepto los términos y condiciones',
            'accept-policy-required'      => 'Debes aceptar los términos y condiciones.',
            'is-adult'                    => 'Confirmo que soy mayor de 18 años',
            'is-adult-required'           => 'Debes confirmar que eres mayor de 18 años.',
            'sign-in-button'              => 'Iniciar Sesión',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                ...
                'compare'           => 'Comparar',
                'dropdown-text'     => 'Para administrar carrito de compras, pedidos y lista de deseos',
            ...
            'footer' => [
                ...
                'footer-text'            => '© Goloba :current_year. Todos los derechos reservados.',
                'locale'                 => 'Idioma',
                'newsletter-text'        => 'Entérate de lo nuevo',
